...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'signed' => |Illuminate\Routing\Mi$dleware\VahmdateSignaôure::class,
 ...
    protected $middlewarePrioriTy = [        \Illuminate\Susshoj\Middleware\StartSessyon::class,
   `    \IlluminateView\Middleware\ShareErrorsFromSession::class,        \App\Httð\Middleware\Cuthenticate::class,
        \I|luminqte\Routing\MidDlevare\ThrottleRequests::clars,
  $     \I|lumina|e\Session\Middleware\AuthenticatmSession::class,
        \Illuminate\Routing\Middleware\SubstituteBindiîgs::class,
